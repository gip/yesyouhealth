...
export default function TermsPage() {
  return (
    <main className="legal-page">
      ...
      <section><h2>7. Your responsibilities</h2><p>Your downloaded export may contain sensitive health information. You are responsible for securing the device, account, storage location, and people with whom you share it. You agree not to misuse, disrupt, reverse engineer, or attempt unauthorized access to the service or connected systems.</p></section>
